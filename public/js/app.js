  ...
  Renderer = function(canvas){
    ...
    var that = {
      init:function(system){
        ...
        particleSystem.screen({padding:[100, 330, 100, 100], // leave some space at the bottom for the param sliders
    ...
    initMouseHandling:function(){
        ...
        $(canvas).click(function(e){
      		...
      		if (selected.node !== null){
      			$.each(particleSystem.getEdgesFrom(selected.node), function(edge) {
